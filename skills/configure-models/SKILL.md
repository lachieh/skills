...
description: Configure provider-specific S, M, L, and XL models and map Lachieh agent roles to those tiers.
disable-model-invocation: true
---

# Configure Models

Create or update `~/.config/lachieh/models.yaml`. This file is the single source
...
Read `~/.config/lachieh/models.yaml` when it exists. Preserve valid explicit
